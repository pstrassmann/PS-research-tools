...
function [] = barScatter(inputCell,errorType,jitter,barColor, errorLineColor, markerColorList)
...
for i=1:numel(meanVect)
    barPlot = bar(i,meanVect(i),'facecolor',barColor); hold on;
    errorLine = line([i i],[meanVect(i)+errorVect(i) meanVect(i)-errorVect(i)]); hold on;
    set(errorLine,'linewidth',4)
